...
V2=Path(r"C:\Users\decla\Desktop\AlgoResearch\Quant Pipeline V2")
MODULES=[
 "models.py","registry.py","config.py","data/universe.py","data/corporate_actions.py","data/panel.py","data/source.py","data/snapshot.py",
 "features/base.py","features/formulas.py","targets/builder.py","cache/rank_store.py","scan/dual_coarse.py","governance/access.py","execution/quote_replay.py"
]
