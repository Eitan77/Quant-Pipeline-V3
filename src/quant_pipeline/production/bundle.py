...
def build_v3_analysis_bundle(*,run_root:Path,research:dict,source_manifest_hash:str,trial_coverage:dict)->Path:
    ...
    zoom_empty={"specialist_summary":["pair_id","target_id","resolution"],"variant_summary":["pair_id","target_id","resolution"],"edge_registry":["candidate_id","status","direction","edge_family_id"],"candidate_summary":["candidate_id","pair_id","target_id","resolution"]}
